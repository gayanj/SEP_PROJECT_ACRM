namespace ACRMS.DISK.Smart
{
    ...
    class SmartData
    {
        ...
        {
            this.attributes = new Dictionary<SmartAttributeType, SmartAttribute>();
            for (int offset = 2; offset < arrVendorSpecific.Length;)
            {
                ...
                {
                    this.attributes[a.AttributeType] = a;
                }
            }

            this.structureVersion = (ushort)((arrVendorSpecific[0] * 256) + arrVendorSpecific[1]);
        }
