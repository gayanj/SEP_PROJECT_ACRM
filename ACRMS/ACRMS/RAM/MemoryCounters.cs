    ...
    public partial class MemoryCounters : Form
    {
        ...
        void tick_Tick2(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                RAMWCF.PercentageCommittedBytesInUse = val1;
                RAMWCF.AvailableBytes = val2;
                RAMWCF.CacheBytes = val3;
                RAMWCF.CacheBytesPeak = val4;
                RAMWCF.CacheFaultsSec = val5;
                RAMWCF.CommitLimit = val6;
                RAMWCF.CommittedBytes = val7;
                RAMWCF.DemandZeroFaults = val8;
                RAMWCF.FreeAndZeroPageListBytes = val9;
                RAMWCF.FreeSystemPageTableEntries = val10;
                RAMWCF.ModifiedPageListBytes = val11;
                RAMWCF.PageFaultsSec = val12;
                RAMWCF.PageReadsSec = val13;
                RAMWCF.PageWritesSec = val14;
                RAMWCF.PageInputsSec = val15;
                RAMWCF.PageOutputsSec = val16;
                RAMWCF.PagesSec = val17;
                RAMWCF.WriteCopiesSec = val18;
